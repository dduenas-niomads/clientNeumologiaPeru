			...
			<div class="left-side">
				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
						...
						<li><a class="current" href="{{ url('/contact') }}">Contacto</a></li>
...
<div class="contact-map margin-bottom-60">
	...
	<div id="singleListingMap-container">
		<div id="singleListingMap" data-latitude="-12.132143" data-longitude="-76.9952067" data-map-icon="im im-icon-Map2"></div>
	...
	<div class="address-box-container">
		<div class="address-container" data-background-image="images/our-office.jpg">
			<div class="office-address">
				<h3>Nuestro consultorio</h3>
				<ul>
					<li>Jirón Guillermo Peratta 394</li>
					<li>Oficina 107</li>
					<li>Santiago de Surco, Lima</li>
					<li>+51 964 074 943</li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<h4 class="headline margin-bottom-30">Visítanos</h4>

			<!-- Contact Details -->
			<div class="sidebar-textbox">
				<p>Haz tu reserva en línea y visítanos para tener una atención privada en cualquiera de nuestros servicios.</p>

				<ul class="contact-details">
					<li><i class="im im-icon-Phone-2"></i> <strong>Teléfono:</strong> <span>(+51) 964 074 943 </span></li>
					<li><i class="im im-icon-Globe"></i> <strong>Web:</strong> <span><a href="#">neumologiayneumopediatria.com</a></span></li>
					<li><i class="im im-icon-Envelope"></i> <strong>E-Mail:</strong> <span><a href="#">vanessaloayzasalazar@gmail.com</a></span></li>
				</ul>
			</div>
			...
			<section id="contact">
				...
				<div id="contact-message"></div> 
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div>
								<input name="email" type="email" id="email" placeholder="Teléfono o correo electrónico" pattern="^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$" required="required" />
							</div>
						</div>
					</div>

					<div>
						<input name="subject" type="text" id="subject" placeholder="Asunto o tema de consulta" required="required" />
					</div>
